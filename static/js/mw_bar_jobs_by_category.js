...
function init(){
    // Indeed Jobs
    d3.json('../static/resources/mw_indeed_jobs.json').then(function(response) {
        ...
        keys.forEach(function(key){
            ...
            category_job_count_list.push(response[key]);
...
function updatePage(){
    ...
    if(dataset == "Government"){
        d3.json('../static/resources/mw_gov_jobs.json').then(function(response) {
            var keys = Object.keys(response);
            ...
            keys.forEach(function(key){
                ...
                department_job_count_list.push(response[key]);
